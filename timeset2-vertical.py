...
class MainWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.button_3.set_tooltip_text("Synchronize Time from the Network using NTP")
        ...
        label = Gtk.Label(label="6. Synchronize H/W Clock to system time")
